...
##set the types
  ...
  transform_x=getTransform(pow = c(1),    ## transformations raise to the powers indicated here.  Default is 1 but can add others
...
#example="gaussian"
  ...
  # print(selected_plot)
    ...
    all_models =dh$makeAllModels(variables, max_model_length=2)
    #dh$plot_angles()
