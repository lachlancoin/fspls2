...
```{r example}
  ...
  runExample<-function(example){
    ...
    datasH = list(dh)   
  #  system.time({
   #this is the step that has parallelisation over folds, and also most time consuming step
  ...
  #  })
    ...
    ggps1=plotEval2(eval1,legend=T, grid1=c("subpheno","pheno"), grid0=c("measure","cv_full"),linetype="data", ##"full_model"
